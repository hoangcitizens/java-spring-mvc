        ...
        <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5">
            <div class="container py-5">
                <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://www.linkedin.com/in/huuhoang-the-consul/" target="_blank">
                                <h1 class="text-primary mb-0">Laptopshop</h1>
                                <p class="text-secondary mb-0">@hoangdev</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author:Nguyễn Hữu Hoàng Dev</p>
                            <p>Website: <a href="https://www.linkedin.com/in/huuhoang-the-consul/" target="_blank">
                                    LinkedIn</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://hoidanit.vn" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Nguyễn Hữu Hoàng Dev</a>, All right
                            reserved.</span>
                    </div>
